...
Po úspěšné instalaci může uživatel kliknout na ikonu rozšíření a otevřít vyskakovací okno (Popup) pro okamžitou správu stavu, nebo přejít do nastavení (Options) kliknutím pravým tlačítkem myši na ikonu a volbou \textit{Možnosti}. Zde lze přidávat vlastní domény do whitelistu či blacklistu.
