...
\item[CORS]		Cross-Origin Resource Sharing — mechanismus sdílení zdrojů napříч doménami
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Zastaralé uživatelské rozhraní}
    \end{subfigure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{img/competitors_Imagus-Reborn_Options.png}
    \caption{Konfigurační rozhraní (Options) konkurenčního rozšíření Imagus}
    \label{fig:imagus}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{img/scr_options_2.png}
    \caption{Stránka s nastavením rozšíření, ukázka sekce pro správu domén a regulárních výrazů}
