...
Cílem této bakalářské práce je navrhnout, implementovat a~otestovat právě takové softwarové řešení -- moderní rozšíření pro webové prohlížeče (zaměřené na platformy Google Chrome a~Mozilla Firefox), které uživatelům umožní okamžité zobrazení interaktivních náhledů obrázků a~dokumentů (zejména formátu PDF). 
...
Běhové prostředí jazyka JavaScript je ve své podstatě jednovláknové (\textit{single-threaded}). Jakákoliv zdlouhavá operace (např.~stahování velkého dokumentu PDF) by v~synchronním režimu zablokovala hlavní vlákno a~způsobila zamrznutí celého uživatelského rozhraní prohlížeče. K~řešení tohoto problému slouží asynchronní programování~\cite{flanagan2020}.
